...
public:
	...
	bool BusquedaIterativa(const char* nodo_inicio, const char* nodo_final, const unsigned int profundidadLimite, const unsigned int deltaProf);
	char* devuelve_ruta();
private:
	bool Busqueda(const char* nodo_inicio, const char* nodo_final, const unsigned int profundidadLimite);
