...
Busqueda_hill_climbing::Busqueda_hill_climbing()
{
...
void Busqueda_hill_climbing::swap_Char(unsigned int indice1, unsigned int indice2, nodo* nodo_actual)
{
...
void Busqueda_hill_climbing::devuelve_enlaces_del_nodo(nodo* nodo_actual)
{
...
bool Busqueda_hill_climbing::esta_en_ancestros(nodo* actual, char* posible_hijo)
{
...
// devuelve un nodo
void Busqueda_hill_climbing::crea_nodo(const char* nombre, nodo* padre, float distancia_al_padre, nodo*& nodo_creado)
{
...
void Busqueda_hill_climbing::agrega_hijo(nodo* padre, nodo* hijo)
{
	hijo->padre = padre;
...
bool Busqueda_hill_climbing::nodos_iguales_en_nombre(const char* nodo1, const char* nodo2)
{
	return(strcmp(nodo1, nodo2) == 0);
}

// Elimina un elemento de la agenda dado por indice 
void Busqueda_hill_climbing::elimina_elemento_agenda(unsigned int indice_a_eliminar)
{
...
void Busqueda_hill_climbing::deja_en_la_agenda_solo_los_mejores_k_elementos(unsigned int k)
{
	nodo* temporal;
...
void Busqueda_hill_climbing::agrega_un_nodo_al_final_de_la_agenda(nodo* nodo_a_agregar)
{
...
bool Busqueda_hill_climbing::busqueda_hill_climbing(const char* nodo_inicio, const char* nodo_final)
{
	...
	while (cantidad_de_elementos_en_la_Agenda != 0)
	{
		...
		// Deja solo el mejor en la agenda
		deja_en_la_agenda_solo_los_mejores_k_elementos(1);
	}
	nodo_encontrado_final = NULL;
	return(false);
}

char* Busqueda_hill_climbing::devuelve_ruta()
{
