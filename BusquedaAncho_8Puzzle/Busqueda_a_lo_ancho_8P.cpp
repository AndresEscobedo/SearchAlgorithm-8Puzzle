...
Busqueda_a_lo_ancho::Busqueda_a_lo_ancho()
{
...
void Busqueda_a_lo_ancho::swap_Char(unsigned int indice1, unsigned int indice2, nodo* nodo_actual)
{
...
void Busqueda_a_lo_ancho::devuelve_enlaces_del_nodo(nodo* nodo_actual)
{
...
bool Busqueda_a_lo_ancho::esta_en_ancestros(nodo* actual, char* posible_hijo)
{
...
// devuelve un nodo
void  Busqueda_a_lo_ancho::crea_nodo(const char* nombre, nodo* padre, nodo*& nodo_creado)
{
...
void  Busqueda_a_lo_ancho::agrega_hijo(nodo* padre, nodo* hijo)
{
	hijo->padre = padre;
...
bool Busqueda_a_lo_ancho::nodos_iguales_en_nombre(const char* nodo1, const char* nodo2)
{
	return(strcmp(nodo1, nodo2) == 0);
}

// Elimina un elemento de la agenda dado por indice 
void Busqueda_a_lo_ancho::elimina_elemento_agenda(unsigned int indice_a_eliminar)
{
...
void Busqueda_a_lo_ancho::agrega_un_nodo_al_final_de_la_agenda(nodo* nodo_a_agregar)
{
...
bool Busqueda_a_lo_ancho::busqueda_a_lo_ancho(const char* nodo_inicio, const char* nodo_final)
{
...
char* Busqueda_a_lo_ancho::devuelve_ruta()
{
