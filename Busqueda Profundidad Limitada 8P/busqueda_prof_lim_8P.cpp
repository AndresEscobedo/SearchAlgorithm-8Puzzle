...
Busqueda_Profundidad_Limitada::Busqueda_Profundidad_Limitada()
{
...
void Busqueda_Profundidad_Limitada::swap_Char(unsigned int indice1, unsigned int indice2, nodo* nodo_actual)
{
...
void Busqueda_Profundidad_Limitada::devuelve_enlaces_del_nodo(nodo* nodo_actual)
{
...
bool Busqueda_Profundidad_Limitada::esta_en_ancestros(nodo* actual, char* posible_hijo)
{
...
// devuelve un nodo
void  Busqueda_Profundidad_Limitada::crea_nodo(const char* nombre, nodo* padre, nodo*& nodo_creado)
{
...
void  Busqueda_Profundidad_Limitada::agrega_hijo(nodo* padre, nodo* hijo)
{
	hijo->padre = padre;
...
bool Busqueda_Profundidad_Limitada::nodos_iguales_en_nombre(const char* nodo1, const char* nodo2)
{
	return(strcmp(nodo1, nodo2) == 0);
}

// Agrega un nodo al final de la agenda
void Busqueda_Profundidad_Limitada::agrega_un_nodo_al_final_de_la_agenda(nodo* nodo_a_agregar)
{
...
bool Busqueda_Profundidad_Limitada::Busqueda(const char* nodo_inicio, const char* nodo_final, const unsigned int profundidad_limite)
{
	...
	while (cantidad_de_elementos_en_la_Agenda != 0)
	{
		...
		if (nodo_actual->profundidad < profundidad_limite)
		{
...
char* Busqueda_Profundidad_Limitada::devuelve_ruta()
{
